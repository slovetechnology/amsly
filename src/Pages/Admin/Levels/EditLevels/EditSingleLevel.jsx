...
const EditSingleLevel = ({item, handelForms, handleAddup, localState}) => {
    const active = localState.find((data) => data.pack === item.id)
    return (
        <div className="mb-3">
            <div className="grid grid-cols-2">
                ...
                <div className="w-fit ml-auto">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="">
                            {active ?
                            <input onChange={e => handelForms(item.id, e.target.value)} value={active.pricing || ''} type="text" className='border text-sm p-3 rounded-lg' /> : 
