...
const SetupExamMainAutomation = ({ data, closeView, resendSignal, net, allitems, tag }) => {
    ...
    const handleService = (e) => {
        ...
        setPlan(true)
        const findPlan = findData.explans.find((item) => item.pack === allitems.id)
...
export default SetupExamMainAutomation