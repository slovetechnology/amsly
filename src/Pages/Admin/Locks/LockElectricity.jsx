...
const LockElectricity = () => {
  ...
  return (
    <AdminLayout pagetitle="Lock Electricity">
      {loading && <Loading /> }
      <div className="bg-white px-3 pb-4 pt-10 rounded-lg w-full max-w-3xl mx-auto">
        <div className="mb-3">
          {subs.map((item, i) => (
            item.category === 'electricity' && <SingleLockToggler sendData={sendData} key={i} data={item} />
          ))}
...
export default LockElectricity